package com.robert.gdxtutorial.controllers;
 ...
 */
public class BobWorldController {
    ...
    static Map<Keys, Boolean> keys = new HashMap<BobWorldController.Keys, Boolean>();
    static {
    ...
    public BobWorldController(World world) {
        this.world = world;
